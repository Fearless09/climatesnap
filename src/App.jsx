    ...
    if (navigator.geolocation) {
      try {
        ...
        const response = await fetch(
          `${openCageUrl}/json?q=${latitude}+${longitude}&key=${openCageApiKey}`
        );
  ...
  return (
    <Router>
      ...
      <Routes>
        <Route
          index
          element={<Homepage city={city} forecast={forecast} data={weather} />}
        />

        <Route
          path="/city/:city"
          element={<City city={city} forecast={forecast} data={weather} />}
        />
