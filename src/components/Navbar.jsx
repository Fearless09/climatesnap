    ...
    return (
        <nav className="navbar navbar-expand bg-dark position-fixed w-100 top-0 start-0">
            <div className="container-fluid px-5">
                {/* Brand Name */}
                <Link to={'/'} onClick={onBrandClick} className="navbar-brand" href="#">
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div className='mx-auto'>
                        <Search setLoading={setLoading} onSearchChange={onSearchChange} />
                    </div>

                    {/* Links */}
                    <ul className="navbar-nav mb-2 mb-lg-0">
                        <li className="nav-item">
                            <Link to={'/about'} className="nav-link" aria-current="page" href="#">About US</Link>
                        </li>
                        <li className="nav-item">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className="dropdown-menu shadow">
                                <li><a className="dropdown-item hstack" href="https://github.com/Fearless09/climatesnap/tree/master">
